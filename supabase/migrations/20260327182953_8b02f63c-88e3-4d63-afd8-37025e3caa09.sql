CREATE OR REPLACE FUNCTION public.submit_signature(_token text, _signature_data text, _signature_type text, _ip text, _user_agent text, _geolocation text DEFAULT '')
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
